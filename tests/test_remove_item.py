# This file contains tests related to remove an item from the cart, defined as functions, which perform several calls to different files inside pages folder.
